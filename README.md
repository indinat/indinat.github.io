...
L'identifiant Tableau Public d'un indicateur est renseigné dans son code d'intégration Tableau Public, dans la valeur de la balise paramétrique `<param/>` du nom (name) localisé à la 5ème ligne :
